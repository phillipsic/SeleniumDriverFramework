...
public class CaseUICases extends CaseUITest {
    ...
    public void clickNewCase() throws Exception {  test.writeInLog(Common.getMethodName());
    ...
    public void clickSearchAccount(String mainWindow) throws Exception {  test.writeInLog(Common.getMethodName());
    ...
    public void setCaseDescription(String description) throws Exception {  test.writeInLog(Common.getMethodName());
        tool.enterStringUsingId("Iigsi8h", description);
    }

    public void saveNewCase() throws Exception {  test.writeInLog(Common.getMethodName());
    ...
    public void changeCaseStatusToClose() throws Exception {  test.writeInLog(Common.getMethodName());
        tool.selectVisibleTextByID("Igdju7d", "Closed");
        Thread.sleep(1000);
    }

    public void changeJustificationStatusToProblemSolved() throws Exception {  test.writeInLog(Common.getMethodName());
    ...
    public void clickNewNote() throws Exception {  test.writeInLog(Common.getMethodName());
    ...
    public void setNoteDescription(String description) throws Exception {  test.writeInLog(Common.getMethodName());
        tool.enterStringUsingId("Irtjkff", description);
    }

    public void clickViewListNote() throws Exception {  test.writeInLog(Common.getMethodName());
