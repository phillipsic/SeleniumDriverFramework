...
public class CaseUITasks extends CaseUITest {
    ...
    public void clickNewTask() throws Exception {  test.writeInLog(Common.getMethodName());
    ...
    public void saveNewTask() throws Exception {  test.writeInLog(Common.getMethodName());
    ...
    public void setTaskName(String name) throws Exception {  test.writeInLog(Common.getMethodName());
        tool.enterStringUsingId("Iyky4iy", name);
    }

    public void setTaskDescription(String description) throws Exception {  test.writeInLog(Common.getMethodName());
