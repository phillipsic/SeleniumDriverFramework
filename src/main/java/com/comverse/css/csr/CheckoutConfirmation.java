...
public class CheckoutConfirmation extends CheckoutConfirmationCommon {
    ...
    @Override
    public WorkSpace clickOk() throws Exception {  test.writeInLogFile(Common.getMethodName());
    ...
    @Override
    public SubscriberDetails clickOkExpectingSubscriberDashboard() throws Exception {  test.writeInLogFile(Common.getMethodName());
