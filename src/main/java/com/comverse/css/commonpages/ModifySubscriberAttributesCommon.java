...
public class ModifySubscriberAttributesCommon extends CommonMenu {
    ...
    public String getBirthday() throws Exception {  test.writeInLog(Common.getMethodName());
    ...
    public String getLanguage() throws Exception {  test.writeInLog(Common.getMethodName());
        return tool.searchUsingIDandGetTextUsingXpath("p-param-L4:80000", ".//option[@selected='selected']");
    }

    public String getHappyHourStart() throws Exception {  test.writeInLog(Common.getMethodName());
        return tool.getAttributeUsingId("p-param-L4:91170", "value");
    }

    public String getHappyHourEnd() throws Exception {  test.writeInLog(Common.getMethodName());
        return tool.getAttributeUsingId("p-param-L4:91180", "value");
    }

    public void enterBirthday(String birthday) throws Exception {  test.writeInLog(Common.getMethodName());

        tool.enterStringUsingId("p-param-L4:90070", birthday);
    }

    public void enterSecurityWord(String securityWord) throws Exception {  test.writeInLog(Common.getMethodName());

        tool.enterStringUsingId("p-param-L4:91070", securityWord);

    }

    public void enterLanguage(String language) throws Exception {  test.writeInLog(Common.getMethodName());
        tool.selectVisibleTextByID("p-param-L4:80000", language);
    }

    public void enterHappyHourStart(String happyHourStart) throws Exception {  test.writeInLog(Common.getMethodName());

        tool.enterStringUsingId("p-param-L4:91170", happyHourStart);

    }

    public void enterHappyHourEnd(String happyHourEnd) throws Exception {  test.writeInLog(Common.getMethodName());
