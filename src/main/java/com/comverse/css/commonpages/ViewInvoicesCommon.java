...
public class ViewInvoicesCommon extends CommonMenu {
    ...
    public ViewTransactionHistoryCommon clickTransactionHistory() throws Exception {  test.writeInLog(Common.getMethodName());
    ...
    public UnbilledTransactionCommon clickUnbilledTransacations() throws Exception {  test.writeInLog(Common.getMethodName());
    ...
    public ViewPaymentsCommon clickPayments() throws Exception {  test.writeInLog(Common.getMethodName());
    ...
    public ViewInvoiceDetailsCommon clickLastInvoice() throws Exception {  test.writeInLog(Common.getMethodName());

        tool.clickUsingXPath("//table[@id='listInvoices']/tbody/tr[2]/td/a");
        return new ViewInvoiceDetailsCommon(tool, test, user);
    }

    public ViewInvoiceDetailsCommon clickInvoiceNumber(String billrefnumber) throws Exception {  test.writeInLog(Common.getMethodName());

        tool.clickUsingLinkText(billrefnumber);
        return new ViewInvoiceDetailsCommon(tool, test, user);
    }

    public RegisterBillPaymentCommon clickPayLastInvoice() throws Exception {  test.writeInLog(Common.getMethodName());
