...
public class ContactInformationCommon extends CommonMenu {
    ...
    public LoginInformationCommon clickViewLoginInformationLink() throws Exception {  test.writeInLog(Common.getMethodName());

        tool.clickUsingLinkText("View Login Information");
        return new LoginInformationCommon(tool, test, user);
    }

    public MoveMemberCommon clickMoveMember() throws Exception {  test.writeInLog(Common.getMethodName());
    ...
    public ModifyEmployeeContactCommon clickModifyContact() throws Exception {  test.writeInLog(Common.getMethodName());
