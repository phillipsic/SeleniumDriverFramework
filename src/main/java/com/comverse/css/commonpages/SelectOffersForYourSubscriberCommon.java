...
public class SelectOffersForYourSubscriberCommon extends CommonMenu {
    ...
    public void selectOffersForSubscriber(String... SOTable) throws Exception {  test.writeInLog(Common.getMethodName());
        if (SOTable != null) {
    ...
    public SupplementaryOfferDetailsCommon clickOfferDetail(String SOName) throws Exception {  test.writeInLog(Common.getMethodName());
    ...
    public MyBasketCommon clickCancel() throws Exception {  test.writeInLog(Common.getMethodName());
        tool.clickUsingXPath("//input[@value='Cancel'");
        return new MyBasketCommon(tool, test, user);
    }

    public void clickOfferDetailOnPopUp(String SOName) throws Exception {  test.writeInLog(Common.getMethodName());
        tool.clickUsingXPath("//div[@class = 'objectName' and contains(.,'" + SOName + "')]/../a");
