...
public class SearchAddressCommon extends CommonMenu {
    ...
    public void setCountry(String country) throws Exception {  test.writeInLog(Common.getMethodName());
    ...
    public SearchAddressCommon clickOk() throws Exception {  test.writeInLog(Common.getMethodName());
        tool.clickUsingXPath("//input[@value='OK']");
        Common.waitForEndOfWaitingPage(tool, this.getClass().getSimpleName());
        return new SearchAddressCommon(tool, test, user);
    }

    public EnterIdentificationDataCommon clickSelectAddress() throws Exception {  test.writeInLog(Common.getMethodName());
