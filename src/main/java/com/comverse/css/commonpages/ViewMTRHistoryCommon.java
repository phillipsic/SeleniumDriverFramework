...
public class ViewMTRHistoryCommon extends CommonMenu {
    ...
    public ViewMTRHistoryCommon(WebDriver driver) throws Exception {
        super(driver);
    ...
    public String getSearchResults() throws Exception {
        ...
        // String text = driver.findElement(By.className("art-button").linkText("Submit")).getText();
    ...
    public ViewMTRDetailsCommon ViewMTRDetails() throws Exception {
        ...
        return new ViewMTRDetailsCommon(driver);
