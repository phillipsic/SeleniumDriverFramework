...
public class ViewUnbilledRCNRCCommon extends CommonMenu {
    ...
    public ViewUnbilledRCTermDetailsCommon clickFirstRCTerm() throws Exception {  test.writeInLog(Common.getMethodName());
    ...
    public ViewUnbilledNRCTermDetailsCommon clickFirstNRCTerm() throws Exception {  test.writeInLog(Common.getMethodName());
