...
public class ModifyEmployeeContactCommon extends CommonMenu {
    ...
    /*
     * public void addEmployeeInfo() throws Exception {  test.writeInLog(Common.getMethodName());
     * 
    ...
    public ModifyEmployeeContactConfirmationCommon clickOk() throws Exception {  test.writeInLog(Common.getMethodName());
