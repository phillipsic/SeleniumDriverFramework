...
public class RequestsForCustomer extends RequestsForCustomerCommon {
    ...
    public void waitUntilBizFirstRequestCompletedOrFailed() throws Exception {  test.writeInLogFile(Common.getMethodName());
    ...
    public String getBizFirstRequestStatus() throws Exception {  test.writeInLogFile(Common.getMethodName());
    ...
    @Override
    public OrderDetails clickOnOrderNumberLink(String orderNumber) throws Exception {  test.writeInLogFile(Common.getMethodName());
