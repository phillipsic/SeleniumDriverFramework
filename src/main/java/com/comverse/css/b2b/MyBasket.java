...
public class MyBasket extends MyBasketCommon {
    ...
    @Override
    public Shopping changePrimaryOffer() throws Exception {  test.writeInLog(Common.getMethodName());
    ...
    @Override
    public ParkTheCurrentBasket clickParkBasket() throws Exception {  test.writeInLog(Common.getMethodName());
    ...
    @Override
    public CheckoutReview clickCheckOut() throws Exception {  test.writeInLog(Common.getMethodName());
        super.clickCheckOut();
        return new CheckoutReview(tool, test, user);
    }

    @Override
    public CheckoutDeliveryAddress clickCheckOutWithGoods() throws Exception {  test.writeInLog(Common.getMethodName());
        super.clickCheckOutWithGoods();
        return new CheckoutDeliveryAddress(tool, test, user);
    }

    @Override
    public Shopping clickContinueShopping() throws Exception {  test.writeInLog(Common.getMethodName());
    ...
    @Override
    public RemoveSelection removeFirstItemFromBasket() throws Exception {  test.writeInLog(Common.getMethodName());
        super.removeFirstItemFromBasket();
        return new RemoveSelection(tool, test, user);
    }

    @Override
    public RemoveBasket clickClear() throws Exception {  test.writeInLog(Common.getMethodName());
        super.clickClear();
