...
public class BKM0020_Empty_basket extends CSSTest {
    ...
    public void testBKM0020_Empty_basket() throws Exception {
        ...
        try {
            ...
            Common.assertVerifyTrue(tool, myBasket.getOfferName().matches(po_BusinessUltraPostpaid.getOfferName() + "[\\s\\S]*$"));
            ...
            accountDetails = removeBasket.clickYes();

            accountDetails.clickCartIcon();
            myBasket = accountDetails.clickViewBasket();
