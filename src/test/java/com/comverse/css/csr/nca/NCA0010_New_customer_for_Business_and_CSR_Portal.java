...
public class NCA0010_New_customer_for_Business_and_CSR_Portal extends CSSTest {
    ...
    @Test
    public void testNCA0010_New_customer_for_Business_and_CSR_Portal() throws Exception {
        try {
            ...
            shopping.filterSubscriberBundlePrimaryOfferByName(po_BusinessUltraPostpaid.getOfferName());
