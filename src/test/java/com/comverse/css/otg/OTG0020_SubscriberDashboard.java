...
public class OTG0020_SubscriberDashboard extends CSSTest {
    ...
    @Test
    public void testOTG0020_SubscriberDashboard() throws Exception {
        ...
        try {
            ...
            SubscriberDashboard sub = act.enterFirstSubscriber(cop.getSubscriber().getSubscriberMSISDNProperty());

            sub.swipeTOLeftSubscriber(otg);
