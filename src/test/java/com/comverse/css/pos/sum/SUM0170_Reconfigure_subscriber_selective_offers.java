...
public class SUM0170_Reconfigure_subscriber_selective_offers extends CSSTest {
    ...
    public void testSUM0170_Reconfigure_subscriber_selective_offers() throws Exception {
        ...
        try {
            String SUPPLEMENTARY_OFFER_1 = "2010 World Cup Soccer News";
            String SUPPLEMENTARY_OFFER_2 = "2010 Super Bowl News";
            ...
            selectOffersForYourSubscriber.selectOffersForSubscriber(SUPPLEMENTARY_OFFER_1, SUPPLEMENTARY_OFFER_2);
            ...
            Common.assertTextOnPage(tool, SUPPLEMENTARY_OFFER_1);
            Common.assertTextOnPage(tool, SUPPLEMENTARY_OFFER_2);
            ...
            // Unselect the SO
            selectOffersForYourSubscriber.selectOffersForSubscriber(SUPPLEMENTARY_OFFER_1);
            ...
            requestsForCustomer.waitUntilFirstRequestCompletedOrFailed();
            requestsForCustomer.clickToSubscriberDashboard();
            Common.assertTextNotOnPage(tool, SUPPLEMENTARY_OFFER_1);
            Common.assertTextOnPage(tool, SUPPLEMENTARY_OFFER_2);
