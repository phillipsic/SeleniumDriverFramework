...
public class RBM0040_Display_balance_details extends CSSTest {
    ...
    public void testRBM0040_Display_balance_details() throws Exception {
        ...
        try {
            ...
            // String acctBalanceNightWeekendName =
            // tool.getAttributeUsingId(balanceNightWeekendName + "_target",
            // "value");
            // String acctBalanceAnytimeName =
            // tool.getAttributeUsingId(balanceAnytimeName + "_target",
            // "value");
