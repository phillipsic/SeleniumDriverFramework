...
public class OCM0001_Add_Images extends AppTest {
    ...
    public void testOCM0001_Add_Images() throws Exception {
        ...
        this.inputFile = "src\\test\\java\\com\\company\\css\\OCM\\Data\\images.xls";
        ...
        for (int i = 1; i < sheet.getRows(); i++) {
            ...
            ImageDetails = System.getProperty("user.dir") + "\\src\\test\\java\\com\\company\\css\\OCM\\Data\\Img\\" + cell.getContents();
